...
const form = reactive({
  ...
  postalCode: '2000',
  region: 'gauteng',
  about: 'Active community member passionate about improving housing conditions and youth development in my neighborhood.',
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                <nav class="flex">
                    ...
                    :class="activeTab === 'profile' ? 'bg-white text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                    >
                    ...
                    :class="activeTab === 'password' ? 'bg-white text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                    >
                    ...
                    class="px-6 py-4 text-lg font-medium flex items-center"
                    :class="activeTab === 'notifications' ? 'bg-white text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                    >
                    ...
                    :class="activeTab === 'privacy' ? 'bg-white text-gray-900' : 'text-gray-500 hover:text-gray-700'"
                    >
                ...
                <div v-if="activeTab === 'notifications'">
                    <h2 class="text-3xl font-bold text-gray-900 mb-8">Notification Preferences</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">Receive email notifications about events, updates, and community activities.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">Receive text message notifications for important updates and reminders.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">Receive our monthly newsletter with community news and updates.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            <label for="event-reminders" class="font-medium text-gray-700">Event Reminders</label>
                            <p class="text-gray-500">Receive reminders about upcoming events you've registered for.</p>
                        </div>
                        </div>
                    </div>
                ...
                <div v-if="activeTab === 'privacy'">
                    <h2 class="text-3xl font-bold text-gray-900 mb-8">Privacy Settings</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">Make your profile visible to other SANCO members.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            <label for="contact-info" class="font-medium text-gray-700">Show Contact Information</label>
                            <p class="text-gray-500">Allow other members to see your contact information.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            <label for="activity-tracking" class="font-medium text-gray-700">Activity Tracking</label>
                            <p class="text-gray-500">Allow SANCO to track your activity on the platform for a better experience.</p>
                        </div>
                        </div>
                        ...
                        <div class="ml-3 text-sm">
                            ...
                            <p class="text-gray-500">Allow SANCO to share anonymized data with partners for research purposes.</p>
                        </div>
                        </div>
                    </div>
