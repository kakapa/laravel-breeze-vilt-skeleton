...
<template>
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <Link href="/">
            <img class="mx-auto h-20 w-auto" :src="logo" alt="SANCO Logo" />
        </Link>
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Create a new account</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          Or
          <Link href="/login" class="font-medium text-orange-500 hover:text-orange-600">
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form class="space-y-6" @submit.prevent="submit">
            ...
            <div>
                <InputLabel for="password_confirmation" value="Confirm PIN (5-digits)" />
            ...
            <div class="flex items-center">
              <input id="terms" name="terms" type="checkbox" required v-model="termsAccepted" class="h-4 w-4 text-orange-500 focus:ring-orange-500 border-gray-300 rounded" />
              <label for="terms" class="ml-2 block text-sm text-gray-900">
                I agree to the
                <a href="#" class="font-medium text-orange-500 hover:text-orange-600">Terms and Conditions</a>
                and
                <a href="#" class="font-medium text-orange-500 hover:text-orange-600">Privacy Policy</a>
              </label>
            </div>
